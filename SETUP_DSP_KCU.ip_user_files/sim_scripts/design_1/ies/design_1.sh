...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"../../../../SETUP_DSP_KCU.gen/sources_1/bd/design_1/ipshared/8713/hdl" \
       +incdir+"../../../../SETUP_DSP_KCU.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../SETUP_DSP_KCU.gen/sources_1/bd/design_1/ipshared/d0f7"
}
