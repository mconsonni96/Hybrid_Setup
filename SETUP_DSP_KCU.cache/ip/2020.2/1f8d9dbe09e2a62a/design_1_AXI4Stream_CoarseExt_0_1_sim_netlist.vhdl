...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Engine_EQ_TC is
  ...
  attribute SOFT_HLUTNM of \din[15]_i_1\ : label is "soft_lutpair20";
...
\din[15]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_FIFO_Synchronizer is
  ...
  attribute READ_DATA_WIDTH : integer;
  attribute READ_DATA_WIDTH of Inst_xpm_fifo_async : label is 17;
  attribute READ_MODE : string;
  ...
  attribute WRITE_DATA_WIDTH : integer;
  attribute WRITE_DATA_WIDTH of Inst_xpm_fifo_async : label is 17;
  attribute WR_DATA_COUNT_WIDTH : integer;
  ...
  attribute SOFT_HLUTNM of \uncalib_tdata[15]_i_2\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \uncalib_tdata_tmp[15]_i_1\ : label is "soft_lutpair18";
...
\uncalib_tdata[15]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\uncalib_tdata_tmp[15]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0080"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_CoarseExtensionCore is
  port (
    ...
    reset_TDC : in STD_LOGIC;
    CoarseCounter_CTD : in STD_LOGIC_VECTOR ( 3 downto 0 );
    s00_axis_subint_tdata : in STD_LOGIC_VECTOR ( 10 downto 0 );
    s00_axis_subint_tvalid : in STD_LOGIC
  );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_CoarseExtensionCore is
  ...
  signal Inst_FIFO_Synchronizer_n_21 : STD_LOGIC;
  ...
  signal dout : STD_LOGIC_VECTOR ( 16 downto 0 );
  signal \^m00_axis_uncalib_tdata\ : STD_LOGIC_VECTOR ( 15 downto 0 );
  ...
  signal \uncalib_tdata[13]_i_2_n_0\ : STD_LOGIC;
  signal \uncalib_tdata[14]_i_1_n_0\ : STD_LOGIC;
  signal \uncalib_tdata[15]_i_1_n_0\ : STD_LOGIC;
  signal \uncalib_tdata[15]_i_3_n_0\ : STD_LOGIC;
  ...
  signal uncalib_tdata_tmp : STD_LOGIC_VECTOR ( 15 downto 0 );
  ...
  attribute SOFT_HLUTNM of \uncalib_tdata[13]_i_2\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \uncalib_tdata[15]_i_3\ : label is "soft_lutpair21";
...
\din[10]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"E2"
    )
        port map (
...
\uncalib_tdata[13]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000FF20"
    )
        port map (
...
\uncalib_tdata[13]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\uncalib_tdata[15]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000FFA8"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI4Stream_CoarseExtensionCore is
  ...
  attribute BIT_SUB_INT of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI4Stream_CoarseExtensionCore : entity is 10;
  attribute BIT_UNCALIBRATED : integer;
  attribute BIT_UNCALIBRATED of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI4Stream_CoarseExtensionCore : entity is 10;
  attribute CDC_SYNC_STAGES : integer;
