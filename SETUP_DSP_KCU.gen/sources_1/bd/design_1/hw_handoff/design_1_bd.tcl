...
proc create_hier_cell_Sync { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 3 -to 0 CoarseCounter_CTD
  ...
  # Create instance: AXI4Stream_HybridTDL_0, and set properties
  set AXI4Stream_HybridTDL_0 [ create_bd_cell -type ip -vlnv DigiLAB:ip:AXI4Stream_HybridTDL:1.0 AXI4Stream_HybridTDL_0 ]
  set_property -dict [ list \
   CONFIG.BIT_SMP_PRE_TDL {128} \
   CONFIG.DEBUG_MODE {true} \
   CONFIG.NUMBER_OF_CARRY_CHAINS {2} \
   CONFIG.NUMBER_OF_DSP_CHAINS {2} \
   CONFIG.NUM_TAP_PRE_TDL {128} \
   CONFIG.TYPE_TDL_0 {O} \
   CONFIG.TYPE_TDL_1 {O} \
 ] $AXI4Stream_HybridTDL_0
  ...
  set_property -dict [ list \
   ...
   CONFIG.TYPE_EDGE_0 {UP} \
   CONFIG.TYPE_EDGE_1 {UP} \
   CONFIG.TYPE_EDGE_2 {UP} \
   CONFIG.TYPE_EDGE_3 {UP} \
  ...
  set_property -dict [ list \
   CONFIG.BIT_COARSE {8} \
   CONFIG.BIT_FID {2} \
   CONFIG.HOLD_ON_INTEGRAL {6} \
   CONFIG.HOLD_ON_MIN_MOD {0} \
  ...
  connect_bd_intf_net -intf_net AXI4Stream_HybridTDL_0_m00_axis_undeco [get_bd_intf_pins AXI4Stream_HybridTDL_0/m00_axis_undeco] [get_bd_intf_pins AXI4Stream_IperDecod_0/S00_AXIS_UnDeco]
  ...
  connect_bd_intf_net -intf_net S00_BB_0_1 [get_bd_intf_pins S00_BB_0] [get_bd_intf_pins BeltBus_NodeInserter_0/S00_BB]
  ...
  connect_bd_net -net CalibEventIn_1 [get_bd_pins CalibEventIn] [get_bd_pins AXI4Stream_HybridTDL_0/AsyncInput]
  ...
  connect_bd_net -net TDCChannelSlice_0_ValidNumberOfTdl [get_bd_pins AXI4Stream_HybridTDL_0/ValidNumberOfTdl] [get_bd_pins TDCChannelSlice_0/ValidNumberOfTdl]
  connect_bd_net -net TDCChannelSlice_0_ValidPositionTap [get_bd_pins AXI4Stream_HybridTDL_0/ValidPositionTap] [get_bd_pins TDCChannelSlice_0/ValidPositionTap]
  ...
  connect_bd_net -net clk_TDC_1 [get_bd_pins clk_TDC] [get_bd_pins AXI4Stream_CoarseExt_0/clk_TDC] [get_bd_pins AXI4Stream_HybridTDL_0/clk] [get_bd_pins AXI4Stream_IperDecod_0/clk] [get_bd_pins TDCChannelSlice_0/clk_TDC]
  ...
  connect_bd_net -net reset_TDC_1 [get_bd_pins reset_TDC] [get_bd_pins AXI4Stream_CoarseExt_0/reset_SYS] [get_bd_pins AXI4Stream_CoarseExt_0/reset_TDC] [get_bd_pins AXI4Stream_HybridTDL_0/reset] [get_bd_pins AXI4Stream_IperDecod_0/reset] [get_bd_pins AXI4Stream_MagicCali_0/reset] [get_bd_pins AXI4Stream_OverflowC_0/reset] [get_bd_pins BeltBus_NodeInserter_0/reset]
  ...
  connect_bd_net -net xlconstant_2_dout [get_bd_pins AXI4Stream_HybridTDL_0/PolarityIn] [get_bd_pins xlconstant_2/dout]
...
proc create_hier_cell_Ch2 { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net AXI4Stream_OverflowC_0_m00_axis_beltbus [get_bd_intf_pins AXI4Stream_OverflowC_0/m00_axis_beltbus] [get_bd_intf_pins AXI4Stream_Synchroni_0/S00_AXIS]
  connect_bd_intf_net -intf_net AXI4Stream_Synchroni_0_M00_AXIS [get_bd_intf_pins AXI4Stream_Synchroni_0/M00_AXIS] [get_bd_intf_pins BeltBus_NodeInserter_0/S00_AXIS]
  connect_bd_intf_net -intf_net BeltBus_NodeInserter_0_M00_AXIS [get_bd_intf_pins BeltBus_NodeInserter_0/M00_AXIS] [get_bd_intf_pins TDCChannelSlice_2/S00_AXIS_Period]
  connect_bd_intf_net -intf_net BeltBus_NodeInserter_0_M00_BB [get_bd_intf_pins M00_BB] [get_bd_intf_pins BeltBus_NodeInserter_0/M00_BB]
  ...
  connect_bd_net -net TDCChannelSlice_2_ValidNumberOfTdl [get_bd_pins AXI4Stream_HybridTDL_0/ValidNumberOfTdl] [get_bd_pins TDCChannelSlice_2/ValidNumberOfTdl]
  connect_bd_net -net TDCChannelSlice_2_ValidPositionTap [get_bd_pins AXI4Stream_HybridTDL_0/ValidPositionTap] [get_bd_pins TDCChannelSlice_2/ValidPositionTap]
  ...
  connect_bd_net -net clk_TDC_1 [get_bd_pins clk_TDC] [get_bd_pins AXI4Stream_CoarseExt_0/clk_TDC] [get_bd_pins AXI4Stream_HybridTDL_0/clk] [get_bd_pins AXI4Stream_IperDecod_0/clk] [get_bd_pins TDCChannelSlice_2/clk_TDC]
  connect_bd_net -net reset_TDC_1 [get_bd_pins reset_TDC] [get_bd_pins AXI4Stream_CoarseExt_0/reset_SYS] [get_bd_pins AXI4Stream_CoarseExt_0/reset_TDC] [get_bd_pins AXI4Stream_HybridTDL_0/reset] [get_bd_pins AXI4Stream_IperDecod_0/reset] [get_bd_pins AXI4Stream_MagicCali_0/reset] [get_bd_pins AXI4Stream_OverflowC_0/reset] [get_bd_pins BeltBus_NodeInserter_0/reset]
  ...
  connect_bd_net -net xlconstant_3_dout [get_bd_pins AXI4Stream_HybridTDL_0/PolarityIn] [get_bd_pins xlconstant_3/dout]
...
proc create_hier_cell_Ch1 { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net AXI4Stream_OverflowC_0_m00_axis_beltbus [get_bd_intf_pins AXI4Stream_OverflowC_0/m00_axis_beltbus] [get_bd_intf_pins AXI4Stream_Synchroni_0/S00_AXIS]
  connect_bd_intf_net -intf_net AXI4Stream_Synchroni_0_M00_AXIS [get_bd_intf_pins AXI4Stream_Synchroni_0/M00_AXIS] [get_bd_intf_pins BeltBus_NodeInserter_0/S00_AXIS]
  connect_bd_intf_net -intf_net BeltBus_NodeInserter_0_M00_AXIS [get_bd_intf_pins BeltBus_NodeInserter_0/M00_AXIS] [get_bd_intf_pins TDCChannelSlice_1/S00_AXIS_Period]
  connect_bd_intf_net -intf_net BeltBus_NodeInserter_0_M00_BB [get_bd_intf_pins M00_BB] [get_bd_intf_pins BeltBus_NodeInserter_0/M00_BB]
  connect_bd_intf_net -intf_net S00_BB_1 [get_bd_intf_pins S00_BB] [get_bd_intf_pins BeltBus_NodeInserter_0/S00_BB]
  ...
  connect_bd_net -net TDCChannelSlice_1_ValidNumberOfTdl [get_bd_pins AXI4Stream_HybridTDL_0/ValidNumberOfTdl] [get_bd_pins TDCChannelSlice_1/ValidNumberOfTdl]
  connect_bd_net -net TDCChannelSlice_1_ValidPositionTap [get_bd_pins AXI4Stream_HybridTDL_0/ValidPositionTap] [get_bd_pins TDCChannelSlice_1/ValidPositionTap]
  ...
  connect_bd_net -net clk_TDC_1 [get_bd_pins clk_TDC] [get_bd_pins AXI4Stream_CoarseExt_0/clk_TDC] [get_bd_pins AXI4Stream_HybridTDL_0/clk] [get_bd_pins AXI4Stream_IperDecod_0/clk] [get_bd_pins TDCChannelSlice_1/clk_TDC]
  connect_bd_net -net reset_TDC_1 [get_bd_pins reset_TDC] [get_bd_pins AXI4Stream_CoarseExt_0/reset_SYS] [get_bd_pins AXI4Stream_CoarseExt_0/reset_TDC] [get_bd_pins AXI4Stream_HybridTDL_0/reset] [get_bd_pins AXI4Stream_IperDecod_0/reset] [get_bd_pins AXI4Stream_MagicCali_0/reset] [get_bd_pins AXI4Stream_OverflowC_0/reset] [get_bd_pins BeltBus_NodeInserter_0/reset]
